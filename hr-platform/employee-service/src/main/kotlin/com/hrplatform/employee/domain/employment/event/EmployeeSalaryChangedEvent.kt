...
data class EmployeeSalaryChangedEvent(
    ...
    val currency: String,
    val timezone: String,
    val oldBaseSalary: Long?,
    val newBaseSalary: Long,
    val salaryChangeCurrency: String,
    override val actorEmploymentId: Long?,
    override val occurredAt: ZonedDateTime,
) : DomainEvent {
    override val eventId: UUID = UUID.randomUUID()
    override val eventType: String = "EmployeeSalaryChanged"
    ...
    override val action: DomainEventAction = object : DomainEventAction {
        override val type: String = "SALARY_CHANGE"
        override val details: Map<String, Any?> = mapOf(
            "oldBaseSalary" to oldBaseSalary,
            "newBaseSalary" to newBaseSalary,
            "currency" to salaryChangeCurrency,
        )
    }
