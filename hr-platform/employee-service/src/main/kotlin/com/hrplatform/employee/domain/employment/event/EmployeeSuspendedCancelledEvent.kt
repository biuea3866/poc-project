...
data class EmployeeSuspendedCancelledEvent(
    ...
    val currency: String,
    val timezone: String,
    val cancelledHistoryId: Long,
    val cancellationReason: String,
    val previousSuspendReason: String,
    val previousSuspendUntil: LocalDate?,
    override val actorEmploymentId: Long?,
    override val occurredAt: ZonedDateTime,
) : DomainEvent {
    override val eventId: UUID = UUID.randomUUID()
    override val eventType: String = "EmployeeSuspendedCancelled"
    ...
    override val action: DomainEventAction = object : DomainEventAction {
        override val type: String = "SUSPEND_CANCELLED"
        override val details: Map<String, Any?> = mapOf(
            "cancelledHistoryId" to cancelledHistoryId,
            "cancellationReason" to cancellationReason,
            "previousSuspendReason" to previousSuspendReason,
            "previousSuspendUntil" to previousSuspendUntil?.toString(),
        )
    }
