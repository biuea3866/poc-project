...
- 평균 wave 너비 2.625 · 4인 팀 가동률 평균 약 66% — wave 6 피크 7(175%)로 보장. 66% 목표 미달은 본 도메인이 SSOT라 통합 게이트(BE-12)·공통 Controller(BE-11a) 단독 wave가 본질적 병목 (계산: (1+3+4+2+2+7+2+1)/8 = 21/8 = 2.625, 4인 팀 환산 가동률 65.6%)
...
- 총 wave: 8
- 평균 wave 너비: (1+3+4+2+2+7+2+1) / 8 = 21/8 = **2.625**
- 최대 wave 너비: 7 (Wave 6)
- 4인 팀 가동률: 7/4=175% (Wave 6) · 4/4=100% (Wave 3) · 3/4=75% (Wave 2) · 평균 ≈ **65.6%**
- 직선화 비율 (너비 1): 2/8 = 25% — `ticket-guide.md`의 50% 이하 기준 통과
- 70% 목표 미달분(약 4%)은 본 도메인이 SSOT라 통합 게이트(BE-12)·공통 Controller(BE-11a) 단독 wave가 본질적 병목
