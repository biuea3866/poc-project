...
class NotificationTemplateService(
    ...
    /** 유형+채널로 템플릿 조회 */
    fun findByTypeAndChannel(type: NotificationType, channel: NotificationChannel): List<TemplateResponse> {
    ...
    /** 템플릿 수정 */
    @Transactional
    fun update(templateId: Long, request: UpdateTemplateRequest): TemplateResponse {
        val template = templateRepository.findByIdAndDeletedAtIsNull(templateId)
    ...
    fun renderAndSend(
        ...
        val template = templateRepository.findByTypeAndChannelAndIsActiveTrueAndDeletedAtIsNull(type, channel)
