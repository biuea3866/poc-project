...
class ShippingAddressService(
    ...
    /** 배송지 등록 */
    @Transactional
    fun create(memberId: Long, request: ShippingAddressRequest): ShippingAddressResponse {
        // 첫 배송지이면 기본 배송지로 설정
    ...
    /** 배송지 수정 */
    @Transactional
    fun update(memberId: Long, addressId: Long, request: ShippingAddressRequest): ShippingAddressResponse {
    ...
    /** 배송지 삭제 */
    @Transactional
    fun delete(memberId: Long, addressId: Long) {
        val address = findByIdAndMemberId(addressId, memberId)
        address.softDelete()
    }
    ...
    private fun findByIdAndMemberId(addressId: Long, memberId: Long): ShippingAddress {
