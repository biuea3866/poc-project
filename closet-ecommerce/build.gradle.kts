...
// Gateway는 WebFlux, Search는 Elasticsearch 기반이므로 JPA/QueryDSL/Flyway 의존성 제외
val nonJpaModules = setOf("closet-gateway", "closet-search")
val jpaModules = subprojects.filter { it.name !in nonJpaModules }
