...
class ExhibitionController(
    ...
    fun create(@Valid @RequestBody request: ExhibitionCreateRequest): ApiResponse<ExhibitionResponse> {
    ...
    fun activate(@PathVariable id: Long): ApiResponse<ExhibitionResponse> {
        return ApiResponse.ok(exhibitionService.activate(id))
    }

    @PatchMapping("/{id}/end")
    fun end(@PathVariable id: Long): ApiResponse<ExhibitionResponse> {
        return ApiResponse.ok(exhibitionService.end(id))
    }

    @GetMapping("/{id}/products")
    fun getProducts(@PathVariable id: Long): ApiResponse<List<ExhibitionProductResponse>> {
