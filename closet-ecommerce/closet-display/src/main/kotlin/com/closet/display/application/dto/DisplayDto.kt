...
data class BannerResponse(
    ...
    companion object {
        fun from(banner: Banner): BannerResponse = BannerResponse(
            id = banner.id,
            title = banner.title,
...
data class ExhibitionResponse(
    ...
    companion object {
        fun from(exhibition: Exhibition): ExhibitionResponse = ExhibitionResponse(
            id = exhibition.id,
...
data class ExhibitionProductResponse(
    ...
    companion object {
        fun from(ep: ExhibitionProduct): ExhibitionProductResponse = ExhibitionProductResponse(
            id = ep.id,
...
data class RankingResponse(
    ...
    companion object {
        fun from(snapshot: RankingSnapshot): RankingResponse = RankingResponse(
            id = snapshot.id,
