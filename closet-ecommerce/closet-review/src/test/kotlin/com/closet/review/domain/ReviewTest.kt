...
class ReviewTest : BehaviorSpec({
    ...
    fun setCreatedAt(review: Review, createdAt: ZonedDateTime) {
        val field = Review::class.java.getDeclaredField("createdAt")
        field.isAccessible = true
        field.set(review, createdAt)
    }

    fun setUpdatedAt(review: Review, updatedAt: ZonedDateTime) {
    ...
    Given("리뷰 생성 (US-801)") {
        ...
        When("내용이 1000자 초과이면") {
            Then("IllegalArgumentException 발생") {
                shouldThrow<IllegalArgumentException> {
                    Review.create(
                        productId = 1L, orderItemId = 1L, memberId = 1L,
                        rating = 5, content = "가".repeat(1001),
                    )
                }
            }
        }
        ...
        When("내용이 정확히 1000자이면") {
            val review = Review.create(
                productId = 1L, orderItemId = 1L, memberId = 1L,
                rating = 5, content = "가".repeat(1000),
            )
            Then("정상 생성된다") {
    ...
    Given("이미지 관리 (US-801)") {
        ...
        When("이미지를 5장 추가하면") {
            val review = Review.create(
                productId = 1L, orderItemId = 1L, memberId = 1L,
                rating = 5, content = "이미지 5장을 추가하는 테스트 리뷰입니다. 최대 5장까지 가능합니다.",
            )
            repeat(5) { idx ->
        ...
        When("이미지를 6장 추가하면") {
            val review = Review.create(
                productId = 1L, orderItemId = 1L, memberId = 1L,
                rating = 5, content = "이미지 6장을 추가하려는 테스트 리뷰입니다. 최대 5장을 초과합니다.",
            )
            repeat(5) { idx ->
                review.addImage("https://img/$idx.jpg", "https://img/${idx}_thumb.jpg", idx)
            }
        ...
        When("이미지 전체 교체 시 6장이면") {
            val review = Review.create(
                productId = 1L, orderItemId = 1L, memberId = 1L,
                rating = 5, content = "이미지 교체 테스트 리뷰입니다. 6장 교체를 시도하면 실패해야 합니다.",
            )
            val newImages = (0..5).map {
                ReviewImage(review = review, imageUrl = "https://new/$it.jpg", thumbnailUrl = "https://new/${it}_thumb.jpg", displayOrder = it)
            }
        ...
        When("이미지 전체 교체 시 빈 리스트이면") {
            val review = Review.create(
                productId = 1L, orderItemId = 1L, memberId = 1L,
                rating = 5, content = "이미지를 모두 제거하는 교체 테스트 리뷰입니다. hasImage가 false가 됩니다.",
            )
    ...
    Given("리뷰 수정 (US-801)") {
        ...
        When("7일 이내, 3회 미만일 때 수정하면") {
            val review = Review.create(
                productId = 1L, orderItemId = 1L, memberId = 1L,
                rating = 4, content = "원래 리뷰 내용입니다. 이 리뷰를 수정할 예정입니다. 충분한 길이입니다.",
            )
        ...
        When("3회 수정 후 추가 수정하면") {
            val review = Review.create(
                productId = 1L, orderItemId = 1L, memberId = 1L,
                rating = 4, content = "세 번 수정한 리뷰입니다. 추가 수정은 불가합니다. 충분한 길이입니다.",
            )
        ...
        When("7일 이후에 수정하면") {
            val review = Review.create(
                productId = 1L, orderItemId = 1L, memberId = 1L,
                rating = 4, content = "8일 전에 작성한 리뷰입니다. 수정 기한이 지났습니다. 길이 충분합니다.",
            )
        ...
        When("삭제된 리뷰를 수정하면") {
            val review = Review.create(
                productId = 1L, orderItemId = 1L, memberId = 1L,
                rating = 4, content = "삭제된 리뷰를 수정하는 테스트입니다. 이 작업은 실패합니다. 충분한 길이입니다.",
            )
            setCreatedAt(review, ZonedDateTime.now())
            review.delete()
        ...
        When("수정 내용이 20자 미만이면") {
            val review = Review.create(
                productId = 1L, orderItemId = 1L, memberId = 1L,
                rating = 4, content = "수정 내용 길이 검증 테스트입니다. 수정 시에도 내용 길이를 검증합니다.",
            )
            setCreatedAt(review, ZonedDateTime.now())
    ...
    Given("리뷰 삭제 (US-801)") {
        ...
        When("VISIBLE 리뷰를 삭제하면") {
            val review = Review.create(
                productId = 1L, orderItemId = 1L, memberId = 1L,
                rating = 3, content = "삭제 테스트용 리뷰입니다. VISIBLE에서 DELETED로 전이합니다. 충분합니다.",
            )
            review.delete()
        ...
        When("이미 삭제된 리뷰를 다시 삭제하면") {
            val review = Review.create(
                productId = 1L, orderItemId = 1L, memberId = 1L,
                rating = 3, content = "이미 삭제된 리뷰를 다시 삭제하는 테스트입니다. 상태 전이 불가합니다.",
            )
            review.delete()
    ...
    Given("관리자 블라인드") {
        ...
        When("VISIBLE 리뷰를 블라인드하면") {
            val review = Review.create(
                productId = 1L, orderItemId = 1L, memberId = 1L,
                rating = 3, content = "블라인드 테스트 리뷰입니다. HIDDEN 상태로 변경될 예정입니다. 충분합니다.",
            )
            review.hide()
        ...
        When("HIDDEN 리뷰를 블라인드 해제하면") {
            val review = Review.create(
                productId = 1L, orderItemId = 1L, memberId = 1L,
                rating = 3, content = "블라인드 해제 테스트입니다. VISIBLE로 복원될 예정입니다. 충분한 길이입니다.",
            )
            review.hide()
            review.unhide()
        ...
        When("DELETED 리뷰를 블라인드하면") {
            val review = Review.create(
                productId = 1L, orderItemId = 1L, memberId = 1L,
                rating = 3, content = "삭제된 리뷰를 블라인드 시도하는 테스트입니다. 전이 불가합니다. 길이 충분.",
            )
            review.delete()
    ...
    Given("포인트 계산 (US-803)") {
        ...
        When("텍스트 리뷰만 작성하면") {
            val review = Review.create(
                productId = 1L, orderItemId = 1L, memberId = 1L,
                rating = 4, content = "텍스트 리뷰입니다. 포인트 100P가 적립되어야 합니다. 충분한 길이의 리뷰입니다.",
            )
        ...
        When("텍스트 리뷰 + 사이즈 정보") {
            val review = Review.create(
                ...
                height = 170, weight = 65, fitType = FitType.SMALL,
            )
        ...
        When("포토 리뷰 + 사이즈 정보 (최대 조합)") {
            val review = Review.create(
                ...
                height = 180, weight = 75, fitType = FitType.LARGE,
            )
            review.addImage("https://img.jpg", "https://thumb.jpg", 0)
    ...
    Given("도움이 됐어요 카운트") {
        ...
        When("incrementHelpfulCount를 호출하면") {
            val review = Review.create(
                productId = 1L, orderItemId = 1L, memberId = 1L,
                rating = 4, content = "도움이 됐어요 카운트 테스트 리뷰입니다. 카운트가 증가해야 합니다.",
            )
