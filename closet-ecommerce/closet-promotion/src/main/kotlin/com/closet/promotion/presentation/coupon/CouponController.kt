...
class CouponController(
    ...
    fun createCoupon(@RequestBody @Valid request: CreateCouponRequest): ApiResponse<CouponResponse> {
    ...
    @GetMapping("/my")
    fun getMyCoupons(@RequestParam memberId: Long): ApiResponse<List<MemberCouponResponse>> {
