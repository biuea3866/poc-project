...
class TimeSaleController(
    ...
    fun createTimeSale(@RequestBody @Valid request: CreateTimeSaleRequest): ApiResponse<TimeSaleResponse> {
    ...
    fun purchaseTimeSale(@PathVariable id: Long): ApiResponse<TimeSaleResponse> {
