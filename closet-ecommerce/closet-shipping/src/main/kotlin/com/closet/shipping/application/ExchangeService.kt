...
class ExchangeService(
    ...
    fun createExchangeRequest(memberId: Long, sellerId: Long, request: CreateExchangeRequest): ExchangeRequestResponse {
        ...
        val exchangeRequest = ExchangeRequest.create(
        ...
        logger.info { "교환 신청 완료: id=${saved.id}, orderId=${request.orderId}, originalOption=${request.originalProductOptionId}, newOption=${request.newProductOptionId}" }
    ...
    fun findById(id: Long): ExchangeRequestResponse {
        val exchangeRequest = exchangeRequestRepository.findById(id)
     ...
     */
    @Transactional
    fun schedulePickup(id: Long, pickupTrackingNumber: String?): ExchangeRequestResponse {
     ...
     */
    @Transactional
    fun startReshipping(id: Long, newTrackingNumber: String?): ExchangeRequestResponse {
        val exchangeRequest = getExchangeRequestOrThrow(id)
