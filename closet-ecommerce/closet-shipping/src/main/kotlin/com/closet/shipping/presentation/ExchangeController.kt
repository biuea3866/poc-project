...
class ExchangeController(
    ...
    @GetMapping("/{id}")
    fun getExchangeRequest(@PathVariable id: Long): ApiResponse<ExchangeRequestResponse> {
    ...
    @RoleRequired(MemberRole.SELLER, MemberRole.ADMIN)
    fun completePickup(@PathVariable id: Long): ApiResponse<ExchangeRequestResponse> {
    ...
    @RoleRequired(MemberRole.SELLER, MemberRole.ADMIN)
    fun complete(@PathVariable id: Long): ApiResponse<ExchangeRequestResponse> {
    ...
    @RoleRequired(MemberRole.SELLER, MemberRole.ADMIN)
    fun reject(@PathVariable id: Long): ApiResponse<ExchangeRequestResponse> {
