...
class ShippingServiceTest : BehaviorSpec({
    ...
    Given("송장 등록") {
        ...
        When("이미 송장이 등록된 주문으로 중복 등록 시도") {
            val shipment = Shipment.create(
                orderId = 10L, sellerId = 1L, memberId = 1L,
        ...
        When("정상 수동 송장 등록") {
            val shipment = Shipment.create(
                orderId = 20L, sellerId = 1L, memberId = 1L,
                receiverName = "김철수", receiverPhone = "010-9876-5432",
                zipCode = "06000", address = "서울시 서초구", detailAddress = "서초동",
            )
            ...
            val response = shippingService.registerShipment(
        ...
        When("유효하지 않은 송장번호 형식") {
            val shipment = Shipment.create(
                orderId = 30L, sellerId = 1L, memberId = 1L,
                receiverName = "박영희", receiverPhone = "010-1111-2222",
                zipCode = "06000", address = "서울", detailAddress = "101호",
            )
    ...
    Given("수동 구매확정") {
        ...
        When("DELIVERED 상태에서 구매확정") {
            val shipment = Shipment.create(
                orderId = 40L, sellerId = 1L, memberId = 1L,
                receiverName = "홍길동", receiverPhone = "010-1234-5678",
                zipCode = "06000", address = "서울", detailAddress = "101호",
            )
        ...
        When("DELIVERED가 아닌 상태에서 구매확정") {
            val shipment = Shipment.create(
                orderId = 41L, sellerId = 1L, memberId = 1L,
                receiverName = "홍길동", receiverPhone = "010-1234-5678",
                zipCode = "06000", address = "서울", detailAddress = "101호",
            )
    ...
    Given("자동 구매확정") {
        ...
        When("배송 완료 7일 경과, 반품/교환 없는 건") {
            val shipment = Shipment.create(
                orderId = 50L, sellerId = 1L, memberId = 1L,
                receiverName = "홍길동", receiverPhone = "010-1234-5678",
                zipCode = "06000", address = "서울", detailAddress = "101호",
            )
            shipment.updateStatus(ShippingStatus.IN_TRANSIT)
            ...
            every { shipmentRepository.findAutoConfirmCandidates(any()) } returns listOf(shipment)
        ...
        When("반품 진행 중인 건") {
            val shipment = Shipment.create(
                orderId = 51L, sellerId = 1L, memberId = 1L,
                receiverName = "홍길동", receiverPhone = "010-1234-5678",
                zipCode = "06000", address = "서울", detailAddress = "101호",
            )
            shipment.updateStatus(ShippingStatus.IN_TRANSIT)
