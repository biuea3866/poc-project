...
class CarrierService(
    ...
    @Transactional
    fun registerShipment(carrier: String, prefix: String, request: Map<String, Any>): MockShipment {
    ...
    fun getTracking(carrier: String, trackingNumber: String): MockShipment? {
