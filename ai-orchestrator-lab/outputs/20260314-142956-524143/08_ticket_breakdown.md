...
## Goal
독립 PR이 가능한 크기로 티켓을 쪼개고 lane과 선행 의존성을 할당하며 Pinpoint 구축 같은 cross-lane 티켓을 분리하고 Jira 등록 기준으로 정리한다.

## Output Hint
id, lane, acceptance criteria, dependencies가 있는 티켓 리스트와 Jira 등록 대상 cross-lane 티켓
