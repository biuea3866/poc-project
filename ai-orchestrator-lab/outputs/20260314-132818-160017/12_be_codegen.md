...
## Goal
BE lane 티켓을 기준으로 객체지향, 클린 코드, 헥사고날 아키텍처 원칙에 맞는 Kotlin 코드를 생성하고 BE worktree 계획을 남긴다. 기술 논의가 필요하면 Confluence 기술 문서를 생성한다.

## Output Hint
BE 코드 초안, 변경 파일 목록, worktree 메모, 계층 분리 메모, 필요 시 기술 문서 링크
