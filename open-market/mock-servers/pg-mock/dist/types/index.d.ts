...
export declare enum PgProvider {
...
export type ScenarioType = 'success' | 'error-card-declined' | 'error-insufficient-balance' | 'error-invalid-card' | 'error-expired-card' | 'timeout';
