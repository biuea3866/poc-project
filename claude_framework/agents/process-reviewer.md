...
5. **claim-without-action** — 완료/통과/검증 단언 후 도구 호출 없음, 또는 사용자의 "했어?" 질문 직후 그제서야 실행, 또는 강제 산출물 없는 "완료" 단언 (`rules/COMPLETION-RULE.md`)
...
- Pipeline: `outputs/<y>/PIPELINE.md`
...
- `.claude/`, `commands/ + outputs/`, `agents/`, `skills/`, `commands/` 하위 `.md` 파일 직접 수정
...
- 워크플로우 정의: `commands/audit-feedback-loop.md`
