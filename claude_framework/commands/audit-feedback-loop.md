---
description: 메타-피드백 루프 건강 점검 — 일일 발화 / Stale 제안 / 효과 측정 / 안전 게이트
argument-hint: [날짜 YYYY-MM-DD, 기본=오늘]
---

# /audit-feedback-loop — 메타-피드백 루프 건강 점검
...
5. **claim-without-action 감지** — 다음 패턴 중 하나 이상 (운영 사고 재발 방지):
   ...
   - "전 레포 적용" / "리팩토링 완료" 단언이 `rules/COMPLETION-RULE.md` 의 강제 산출물 없이 나옴
...
| 건강 보고서 | `outputs/feedback-loop/<YYYY-MM-DD>-health.md` |
...
- 출력물 리뷰(별도 축): `commands/review-pr.md`
