---
description: PRD 분석 — PRD 링크/경로를 받아 요구사항 추출, 모호점 식별, 수락 기준 초안 작성. PM/PO 대면용 질의사항 목록 산출.
argument-hint: <PRD URL or path>
---

# /analyze-prd — PRD 분석 절차

`prd-analyst` 에이전트로 다음 절차를 수행해줘.
...
- 관련 기존 설계 문서 검색 (`outputs/analyze-prd/`, `outputs/plan-project/` 과거 산출물)
...
파일 경로: `outputs/analyze-prd/YYYY-MM-DD-<feature-slug>.md`
